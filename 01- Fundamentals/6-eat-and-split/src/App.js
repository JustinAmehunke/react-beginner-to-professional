  ...
  return (
    <div className="app">
      <div className="sidebar">
        <FriendsList friends={friends} onFriendSelection={handleSelection} selectedFriend={selectedFriend} />
...
function Friend({ friend, onFriendSelection, selectedFriend }) {
  ...
  return <li className={isSeleted ? "selected" : ""}>
    ...
    <Button onClick={() => onFriendSelection(friend)}>{isSeleted ? "Close" : "Select"}</Button>
  </li>
}
...
function FormSplitBill({ selectedFriend, onSplitBill }) {
  ...
  return (
    <form className="form-add-friend" onSubmit={handleSubmmit}>
